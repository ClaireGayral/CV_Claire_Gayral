...
This thesis project have been interrupted at the end of the first year, %which has been harder than challenging,
...
Moreover, my experience in the LumenAI company is a testimony to my programming level, and my ability to handle Machine Learning tools in python. In addition to these skills. %I learned this year how to use a remote server, within the framework of a project of integration of omics data.
