...
et je compte utiliser ce temps pour m'investir dans un projet tout autre et découvrir de nouvelles applications du Machine Learning.  %avant de me lancer dans cette nouvelle thèse. 
Ma recherche est donc plus axée sur une mission courte (au plus un an), pour occuper cette période de transition. %Il y a en effet peu d'offres similaire en Machine Learning dans un laboratoire public. %
...
J'ai enchaîné sur 4 mois de stage co-encadré par J. Chiquet et F. Picard, portant sur l'analyse de mesures d'expression et régulation génomique de lymphocytes, en cellule unique. %Le traitement de ces données a été achevé, mais elles contenaient trop peu d'information pour mener un projet de recherche avec. 
Ce travail technique, fait en $R$ n'a pu aboutir à une publication %%sur des mécanismes de régulation responsables de la différentiation de lymphocyte, 
