...
Je viens donc de finir cette année de thèse, qui a été très difficile, car nous n'avons pas réussi à trouver une communication constructive avec un de mes directeur, ce pourquoi il est préférable de changer d'orientation.% de finir avec ce projet.
...
%}    \\
%De plus, mes directeurs m'offrent la possibilité de finir l'année civile sur le financement de la thèse en cours, ce qui permettrait de vous proposer un stage en temps masqué, le mois de décembre. Je peux en effet largement être autonome sur des débuts bibliographiques. 
...
%Mes exigences : 
%\begin{itemize}
%    \item disponibilité en présentiel qu'à partir de janvier
%    \item Réunion de travail : présentiel au moins de temps en temps, ou un outil d'échange efficace (support numérique commun)
    %\item quelques semaines/mois de travail en "temps masqué" (novembre décembre) ? 
%\end{itemize}
%    }
